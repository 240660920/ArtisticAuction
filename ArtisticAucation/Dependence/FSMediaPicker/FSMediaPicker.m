...
#define kTakePhotoString LocalizedString(@"拍照")
#define kSelectPhotoFromLibraryString LocalizedString(@"从相册选择")
#define kRecordVideoString LocalizedString(@"Record video")
#define kSelectVideoFromLibraryString LocalizedString(@"从相册选择")
#define kCancelString LocalizedString(@"取消")
