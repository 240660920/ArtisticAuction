...
@property(nonatomic,strong)UITextView *copRightLabel;
...
-(UILabel *)introLabel
{
    if (!_introLabel) {
        ...
        NSMutableAttributedString *str2 = [[NSMutableAttributedString alloc]initWithString:@"艺众APP是江苏公共文化产业开发有限公司为实现“让艺术品走进千家万户”这一伟大梦想所投资开发的手机在线拍卖平台。\n艺众将深入挖掘艺术品的潜在魅力，整合线上线下资源抵制传统拍卖陋习，为人们搭建一个注重诚信、价格合理、品类齐全的拍卖平台。让所有人都能轻松收藏到心爱的艺术品。" attributes:@{NSForegroundColorAttributeName : _introLabel.textColor , NSFontAttributeName : _introLabel.font , NSParagraphStyleAttributeName : paragraphStyle}];
...
-(UITextView *)copRightLabel
{
    if (!_copRightLabel) {
        _copRightLabel = [[UITextView alloc]init];
        ...
        _copRightLabel.dataDetectorTypes = UIDataDetectorTypePhoneNumber;
        _copRightLabel.editable = NO;
